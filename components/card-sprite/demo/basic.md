...
class Comp extends React.Component {
  ...
  render(){
    ...
    return (<div style={{width: 320, height: 180, position: 'relative', boxShadow: '0 0 0 2px grey'}}>
      <img style={{objectFit: 'contain', width: '100%', height: '100%'}} src={sprite.groups[0].file_url}/>
