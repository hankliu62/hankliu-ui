...
```css
.button-demo .hlui-btn,
.button-demo .hlui-btn-group {
  margin-right: 8px;
  margin-bottom: 12px;
}
.button-demo .hlui-btn-group > .hlui-btn,
.button-demo .hlui-btn-group > span > .hlui-btn {
  margin-right: 0;
  margin-left: 0;
}
...
.hlui-badge-rtl:not(.hlui-badge-not-a-wrapper) {
  margin-right: 0;
  margin-left: 20px;
}
```
