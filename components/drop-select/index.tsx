...
function renderOverlay(title?: React.ReactNode, value?: number | string, options?: DropSelectOptionProps[], onChange?: (value: number | string) => void) {
...
const DropSelect = (props: DropSelectProps) => {
  const {
    title, value, options, onChange, children, ...rest
  } = props;
  return (
