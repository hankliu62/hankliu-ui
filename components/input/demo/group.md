...
.site-input-group-wrapper .hlui-input-rtl.site-input-right {
  border-right-width: 0;
}

.site-input-group-wrapper .hlui-input-rtl.site-input-right:hover,
.site-input-group-wrapper .hlui-input-rtl.site-input-right:focus {
