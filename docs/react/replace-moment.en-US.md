...
First, we initialize an antd demo with `create-react-app`. You can refer to [Use in TypeScript](/docs/react/use-in-typescript), or you can start directly here [init antd](https://github.com/xiaohuoni/antd4x-generate-picker/commit/47fec964e36d48bd15760f8f5abcb9655c259aa6)
...
If the above steps do not work correctly, you can refer to [antd4x-generate-picker/antd-ts](https://github.com/xiaohuoni/antd4x-generate-picker/tree/master/antd-ts).

If you need JavaScript code, you can refer to [antd4x-generate-picker/antd-demo](https://github.com/xiaohuoni/antd4x-generate-picker/tree/master/antd-demo).

If you use [umi](https://umijs.org/), you can reference [antd4x-use-dayjs-replace-moment](https://github.com/xiaohuoni/antd4x-use-dayjs-replace-moment).
